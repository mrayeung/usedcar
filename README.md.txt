...
The objective of this project is to derive a used car pricing model by understanding what factors make a car more or less expensive based on what consumers value in a used car. THe dataset contain data for used car of wide range from 1920s to 2022s. 
...
In terms of risk, the data model doesn't cover all type of vehicle where the model is further segmented to not include collectible car as it has a different valuation method compare to traditional used car. Also truck and exotic car are excluded as exotic car might have brand bias and truck has a different set of attributes different than traditional cars.

Also, car type such as bus and trucks are exlucded in the model as commerical vehicle likely have differet set of valuation comapre to consumer model. 

# Data Understanding

Data is reviewed with observation as following
1. Ford, Chevrolet, Toyota, Nissan and Honda are the top 5 OEMs of user car listings
...
5. In terms of pricing, most listing has a price of $10000
6. In terms of Year, # of year listing with most listing of 2013 which skew toward recent years and trend download for the lower year model. This make sense as most consumer wont prefer to buy model that are made in the past 10 yrs. A hypothesis is that car that are older than 10 yrs, parts may be discounted and it would be harder to be get service due to lack of support by technician. 
...
Data Check
- On cyclinders, 4 cyclinder engine are the most common among used car. Further investigation have shown that the data is incorrectly label some of the highend car such as Ferrari and Porsche should have V8 instead of 4 Cyclinders. After relabeling, it is shown that V8 and V6 car has higher pricing.
